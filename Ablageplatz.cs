...
namespace Beleg2021
{
    public class Ablageplatz : MaschinenModul
    {
        /// <summary>Reinigungszustand des Ablageplatzes. False: noch nicht gereinigt. True: gereinigt.</summary>
        private bool _Reinigungszustand;
        ...
        /// </param>
        public Ablageplatz(string id)
        {
            this._ID = id;
            this._Reinigungszustand = true;
        }
        ...
        /// <summary>
        /// Gibt Reinigungszustand des Ablageplatzes zurück.
        /// </summary>
        public bool GetReinigungszustand()
        {
            return this._Reinigungszustand;
        }

        /// <summary>
        /// Setzt Reinigungszustand des Ablageplatzes.
        /// </summary>
        /// <param name="zustand">
        /// Neuer Reinigungszustand des Ablageplatzes.
        /// </param>
        public void SetReinigungszustand(bool zustand)
        {
            this._Reinigungszustand = zustand;
        }
    }
}